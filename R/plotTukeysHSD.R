...
plotTukeysHSD <- function(tukey.out,
  ...
  graphics::mtext(text = x.axis.label,side = 1,line = 1.75)
  graphics::mtext(text = y.axis.label,side = 2,line = 1.95)
  graphics::mtext(text = "Error bars = 95% CI",side = 3,line = 0,adj = 0)
