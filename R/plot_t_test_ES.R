...
#' @param point.sz Size of point representing the mean.
#'
#' @examples
...
plot_t_test_ES <- function(t.test.out,
                           point.sz = 5){
  ...
  ggplot2::ggplot(data = df) +
    ...
    ggplot2::xlim(0.9,1.1) +
    ggplot2::annotate("text",x = 0.95, y= df$CI.high,label = test.stats) +
